...
function validId(value) {
    if (value ==5){
        ...
        document.getElementById('id_card_no').setAttribute('placeholder',"S1234567A");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter 10 Digit Valid Singapore NRIC No");
    }else if(value ==6){
        ...
        document.getElementById('id_card_no').setAttribute('placeholder',"12345611233");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter 11 digit Valid Passport Number");
    }
}
